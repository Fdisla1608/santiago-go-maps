...
const User = () => {
  ...
  const handleSearch = async (event) => {
    ...
    try {
      const response = await fetch(
        `http://swift-agro.ddns.net:3001/api/user?param=${value}`
      );
      if (!response.ok) {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        `http://swift-agro.ddns.net:3001/api/user?param=${""}`
      );
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
  ...
  async function SelectUser(id) {
    ...
    try {
      const response = await fetch(
        `http://swift-agro.ddns.net:3001/api/cards?userId=${user.id}`
      );
      if (!response.ok) {
        throw new Error("Network response was not ok");
      }
  ...
  async function UpdateUser() {
    ...
    try {
      const response = await fetch(
        `http://swift-agro.ddns.net:3001/api/user?id=${userData.id}`,
        {
          method: method,
          headers: {
  ...
  async function DeleteCard(id) {
    try {
      const response = await fetch(
        `http://swift-agro.ddns.net:3001/api/cards?id=${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  async function DeleteUser(id) {
    try {
      const response = await fetch(`http://swift-agro.ddns.net:3001/api/user?id=${id}`, {
        method: "DELETE",
      });
      if (!response.ok) {
        throw new Error("Network response was not ok");
  ...
  const RegisterCard = async () => {
    try {
      ...
      const response = await fetch(
        `http://swift-agro.ddns.net:3001/api/cards?id=${userData.id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
